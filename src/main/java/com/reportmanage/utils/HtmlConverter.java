package com.reportmanage.utils;
...
public class HtmlConverter {
     ...
     * @throws Exception
     */
    public File saveHtmlToDocx(String url) throws Exception {
        return saveDocx(html2word(url));
    }
     ...
     * @throws Exception
     */
    public WordprocessingMLPackage html2word(String url) throws Exception {
        return xhtml2word(html2xhtml(url));
    }
